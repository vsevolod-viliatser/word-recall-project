...
const WordRepetition = ({ token, onWordsRepeated }) => {
    ...
    <div className="container d-flex justify-content-center align-items-center">
      {hasWordsAvailable ? (
        <form onSubmit={handleSubmit} className="text-center">
          ...
          {word && <h3 className="display-4 mb-4">{word.english}</h3>}
          ...
          <div>
            {sessionCompleted ? (
              <>
                ...
                <Link to="/displays">
                  <button className="btn btn-primary m-2">View Repeated Words</button>
                </Link>
              </>
            ) : (
